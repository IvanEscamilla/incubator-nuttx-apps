...
static void draw_rect8(FAR struct fb_state_s *state, FAR struct fb_area_s *area,
                       int color)
{
    FAR uint8_t *dest;
    FAR uint8_t *row;
...
static void draw_rect1(FAR struct fb_state_s *state, FAR struct fb_area_s *area,
                       int color)
{
    FAR uint8_t *pixel;
    FAR uint8_t *row;
...
static void draw_rect(FAR struct fb_state_s *state, FAR struct fb_area_s *area,
                      int color)
{
...
int main(int argc, FAR char *argv[])
{
    ...
    printf("     area: (%u,%u) => (%u,%u)\n", state.oinfo.sarea.x,
           state.oinfo.sarea.y, state.oinfo.sarea.w, state.oinfo.sarea.h);
    printf("     accl: %" PRIu32 "\n", state.oinfo.accl);
    ...
    for (x = 0, y = 0, color = 0; color < NCOLORS;
